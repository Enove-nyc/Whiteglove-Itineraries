package com.whitegloveadvisor.app;
...
public class MainActivity extends BridgeActivity {
    ...
    private static final String SERVER_URL = "https://whitegloveitineraries.com/advisor";
    ...
    private static final String OFFLINE_HTML =
        "<!doctype html><html><head><meta charset=\"utf-8\">"
            ...
            + "</style></head><body>"
            + "<h1>No connection</h1>"
            + "<p>White Glove Advisor needs the internet to open your dashboard. "
