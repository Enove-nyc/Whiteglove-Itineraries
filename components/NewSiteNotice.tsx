...
export default function NewSiteNotice({ notice }: { notice: BetaNotice }) {
  ...
  // Never on itineraries. The wording is kosher-guide copy ("confirm kashrus,
  // hours and Shabbos arrangements") — it has no business on the general-travel
  // side, which points nothing at the kosher product.
